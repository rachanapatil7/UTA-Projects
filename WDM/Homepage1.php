...
<body>
	...
	<header>
		...
		<pre><nav class="na">
		<a href="Homepage1.php" class="active">Inicio</a>    <a href="AboutUs.php">Quienes Somos</a>    <a href="http://rachananpatil.uta.cloud/lean-event/">Blog</a>    <a href="SignUp.php">Registrate</a>    <a href="ContactUs.php">Contacto</a>    <a href="Login1.php">Iniciar Sesion</a>    <a href="BuyFromUs.php">Comprar Boletos</a> 
...
<div class="container">
	...
	<footer>
		<div><form action="Homepage1.php" method="post" name="subscribe">
...
ini_set('sendmail_from','rachana.n.p.7@gmail.com');
if(isset($_POST["subs"]))
  {
