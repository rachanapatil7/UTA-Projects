...
<body>
		...
		<div class="column" id="c2"><strong id="hp1">LEANEVENTOS</strong></div>
		
		<pre><nav class="na"><strong>
			<a href="BusinessHome.php">Inicio</a>    <a href="BusinessProfile.php" class="active">Individual</a> </strong>   
	</nav></pre>
	</header>
	<div class="container">
	...
	<div class="column" id="pro3">
		<img src="images1/nologo.png" width="150" height="170">
	...
	<center><form action="#" method="" id="ae1">
		...
		<div class="column" id="ae3">
			<img src="images1/nologo.png" width="150" height="170"><br>
