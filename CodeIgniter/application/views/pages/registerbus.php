...
<div id="f_isf">
	...
	<center>
        ...
        <?php
         	$attributes = array('class'=>'f_isf');
            echo form_open('registerbus',$attributes); 
        ...
        ?>		
			...
			<h5 align="left">Registro Negocio o Fundacion</h5><hr>
		        ...
		        <div id="isf6">
		  		...
		  		<div class="clear">&nbsp;</div>
		  		<div class="column">
		  			<?php echo form_label('Tipo de negocio 1');
		  			
		  			echo form_radio('bus',1,'TRUE'); ?>
		  			
		  		</div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 
		  		<div class="column">
		  			<?php echo form_label('Tipo de negocio 2');
		  			
		  			echo form_radio('bus',2,'TRUE'); ?>
		  			
		  		</div>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 
		  		<div class="column">
		  			<?php echo form_label('Tipo de negocio 3');
		  			
		  			echo form_radio('bus',3,'TRUE'); ?>
